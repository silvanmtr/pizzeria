...
public class Mailer {
	...
	public void enviar(Usuario usuario) {
		...
		context.setVariable("venda", usuario);
		context.setVariable("logo", "logo");
		
		Map<String, String> fotos = new HashMap<>();
		boolean adicionarMockCerveja = false;
		for (ItemVenda item : usuario.getItens()) {
		...
		try {
			...
			helper.setTo(usuario.getCliente().getEmail());
			helper.setSubject(String.format("Brewer - Venda nº %d", usuario.getCodigo()));
